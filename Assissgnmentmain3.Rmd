...
##F)comparing the value with the one obtained from the privot table in 0.1.Which is ##more accurate estimate ?  
##      
...
##predict, where the naive bayee method .

##The value obtained from the pivot table is 0.176690941 and the naive bayes probability is 0.100768338 which are almost similar and
## the value of the pivot is more accurate because pivot table does not assume that probabilities are independent.

## G)Performing Naive Bayes on the training data
```{r}
require("e1071")
